package ink.icoding.smartmybatis;
...
public class SpringApplicationUtil implements ApplicationContextAware {
    ...
    protected Logger logger = getLogger(SpringApplicationUtil.class);
    ...
    public static Logger getLogger(Class<?> clazz) {
        try {
            ...
            // 静态方法
            return (Logger) loggerFactoryClass.getMethod("getLogger", Class.class).invoke(null, clazz);
    ...
    public static <T> T register(String name, Class<T> clazz){
        AbstractApplicationContext applicationContext =
                (AbstractApplicationContext) SpringApplicationUtil.getApplicationContext();
